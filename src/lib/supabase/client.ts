...
// Adaptador de almacenamiento hÃƒ­brido (LocalStorage + Cookies)
...
const customAuthStorage = {
  getItem: (key: string): string | null => {
    ...
    try {
      // 1. Intentar desde localStorage (mÃƒ¡xima persistencia en iOS PWA)
  ...
  setItem: (key: string, value: string): void => {
    ...
    try {
      // Guardar en cookie con duraciÃƒ³n de 1 aÃƒ±o (31536000s)
