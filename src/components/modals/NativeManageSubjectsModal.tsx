...
import { X, Plus, Trash2, BookOpen, Check, User, Hash } from 'lucide-react-native'
import { triggerHaptic } from '@/lib/nativeHaptics'
import { supabase } from '@/lib/nativeSupabase'

interface NativeManageSubjectsModalProps {
  visible: boolean
  onClose: () => void
  classroomId: string
  subjects: Subject[]
...
const PALETTE = ['#6366F1', '#10B981', '#8B5CF6', '#F43F5E', '#F59E0B', '#0EA5E9', '#EC4899', '#14B8A6']

export function NativeManageSubjectsModal({
  visible,
  onClose,
  classroomId,
  subjects = [],
  onSubjectsUpdated,
}: NativeManageSubjectsModalProps) {
  ...
  const handleDeleteSubject = (subjectId: string, subjectName: string) => {
    Alert.alert(
      '¿Eliminar materia?',
      `Se eliminará "${subjectName}" y sus asignaciones de horario.`,
      [
      ...
      <View style={styles.backdrop}>
        ...
        <View style={styles.sheetContainer}>
          <View style={styles.sheetHeader}>
            ...
            <Text style={styles.sheetTitle}>Administrar Materias</Text>
          ...
          <ScrollView style={styles.sheetScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formCard}>
              <Text style={styles.formCardTitle}>AGREGAR NUEVA MATERIA</Text>
              ...
              <View style={styles.rowInputs}>
                ...
                <View style={[styles.inputBox, { flex: 1.5 }]}>
            ...
            <View style={styles.listSection}>
              <Text style={styles.listSectionTitle}>MATERIAS DEL SALÓN ({subjects.length})</Text>
                ...
                <View key={subj.id} style={styles.subjectItem}>
                  ...
                  <View style={styles.subjectItemInfo}>
                    ...
                    <Text style={styles.subjectItemDetails}>
                      {subj.code ? `${subj.code} • ` : ''}
                      {subj.teacher_name || 'Sin docente asignado'}
                    </Text>
                  </View>
